...
int main() {
    ...
    // Asignamos el nuevo angulo
    float angle = 60.0f; // Ángulo en grados
    // Asignamos la nueva velocidad y la convertimos de km/h a m/s multiplicando por 0.2778
    float speed = 900.0f * 0.2778; // Velocidad en m/s
